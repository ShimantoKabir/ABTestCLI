...
export const publisherImgLink: string =
  "https://www.f5.com/authors/kara-sprague.thumb.png";
export const publishedDate = "APRIL 06, 2023";
export const publisherName = "KARA SPRAGUE";
export const publisherLink = "https://www.f5.com/authors/kara-sprague";
...
export const selectors = {
  hiddenSectionSelector: "div#platter396527510",
};
